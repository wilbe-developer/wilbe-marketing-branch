...
-- Fix the RPC function to resolve column ambiguity
...
BEGIN
  ...
  IF p_requesting_user_id IS NOT NULL AND 
     ...
     NOT EXISTS (
       ...
       WHERE sprint_collaborators.sprint_owner_id = p_sprint_owner_id 
       AND sprint_collaborators.collaborator_id = p_requesting_user_id
     ) THEN
