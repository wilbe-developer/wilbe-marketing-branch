...
-- Add institution and company_role columns to sprint_profiles table
ALTER TABLE public.sprint_profiles 
ADD COLUMN institution text,
ADD COLUMN company_role text;

-- Update the create_sprint_profile function to include the new parameters
