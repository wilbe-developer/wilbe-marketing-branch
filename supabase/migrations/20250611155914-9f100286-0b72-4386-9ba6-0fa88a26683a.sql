...
-- Drop all specific versions of the create_sprint_profile function by their exact signatures
DROP FUNCTION IF EXISTS public.create_sprint_profile(uuid, text, text, text, text, text, boolean, boolean, text, boolean, text, boolean, boolean, boolean, boolean, text, boolean, text, text, boolean, text[], boolean, boolean) CASCADE;

DROP FUNCTION IF EXISTS public.create_sprint_profile(uuid, text, text, text, text, text, boolean, boolean, text, boolean, text, boolean, boolean, boolean, boolean, text, boolean, text, text, boolean, text[], boolean, boolean, boolean, text, boolean, boolean, boolean, boolean, boolean, boolean, boolean, text[], boolean, text, boolean, text, boolean, boolean, text, boolean) CASCADE;

DROP FUNCTION IF EXISTS public.create_sprint_profile(uuid, text, text, text, text, text, boolean, boolean, text, boolean, text, boolean, boolean, boolean, boolean, text, boolean, text, text, boolean, text[], boolean, boolean, boolean, text, boolean, boolean, boolean, boolean, boolean, boolean, boolean, text[], boolean, text, boolean, text, boolean, boolean, text, boolean, text, text, text, text, text) CASCADE;

DROP FUNCTION IF EXISTS public.create_sprint_profile(uuid, text, text, text, text, text, boolean, boolean, text, boolean, text, boolean, boolean, boolean, boolean, text, boolean, text, text, boolean, text[], boolean, boolean, boolean, text, boolean, boolean, boolean, boolean, boolean, boolean, boolean, text[], boolean, text, boolean, text, boolean, boolean, text, boolean, text, text, text, text, text, text, boolean, timestamp with time zone) CASCADE;

DROP FUNCTION IF EXISTS public.create_sprint_profile(uuid, text, text, text, text, text, boolean, boolean, text, boolean, text, boolean, boolean, boolean, boolean, text, boolean, text, text, boolean, text[], text, boolean, boolean, text, boolean, boolean, boolean, boolean, boolean, boolean, boolean, text[], boolean, text, boolean, text, boolean, boolean, text, boolean, text, text, text, text, text, text, boolean, text) CASCADE;

DROP FUNCTION IF EXISTS public.create_sprint_profile(uuid, text, text, text, text, text, boolean, boolean, text, boolean, text, boolean, boolean, boolean, boolean, text, boolean, text, text, boolean, text[], boolean, boolean, boolean, text, boolean, boolean, boolean, boolean, boolean, boolean, boolean, text[], boolean, text, boolean, text, boolean, boolean, text, boolean, text, text, text, text, text, text, boolean, text) CASCADE;

-- Now create the single, clean version with the correct signature
CREATE OR REPLACE FUNCTION public.create_sprint_profile(
  ...
  p_experiment_validated text, -- TEXT type for string values
