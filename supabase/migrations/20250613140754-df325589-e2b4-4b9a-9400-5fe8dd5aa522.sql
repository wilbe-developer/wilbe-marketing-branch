...
-- Drop all existing versions of create_sprint_profile function
DROP FUNCTION IF EXISTS public.create_sprint_profile(uuid, text, text, text, text, text, boolean, boolean, text, boolean, text, boolean, boolean, boolean, boolean, text, boolean, text, text, boolean, text[], boolean, boolean, boolean, text, boolean, boolean, boolean, boolean, boolean, boolean, boolean, text[], boolean, text, boolean, text, boolean, boolean, text, boolean, text, text, text, text, text, text);

DROP FUNCTION IF EXISTS public.create_sprint_profile(uuid, text, text, text, text, text, boolean, boolean, text, boolean, text, boolean, boolean, boolean, boolean, text, boolean, text, text, boolean, text[], text, boolean, boolean, text, boolean, boolean, boolean, boolean, boolean, boolean, boolean, text[], boolean, text, boolean, text, boolean, boolean, text, boolean, text, text, text, text, text, text, boolean);

DROP FUNCTION IF EXISTS public.create_sprint_profile(uuid, text, text, text, text, text, boolean, boolean, text, boolean, text, boolean, boolean, boolean, boolean, text, boolean, text, text, boolean, text[], text, boolean, boolean, text, boolean, boolean, boolean, boolean, boolean, boolean, boolean, text[], boolean, text, boolean, text, boolean, boolean, text, boolean, text, text, text, text, text, text, boolean, text);

-- Keep only the latest version with all parameters including institution and company_role
-- This function should already exist from our previous migration, but let's ensure it's correct
CREATE OR REPLACE FUNCTION public.create_sprint_profile(
  ...
  p_company_role text DEFAULT NULL::text
)
RETURNS void
LANGUAGE plpgsql
AS $function$
