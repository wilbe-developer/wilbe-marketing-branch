  ...
  return <div className="max-w-6xl mx-auto px-4">
      ...
      <section className="mb-12 allow-overflow-x">
        <div className="flex items-center justify-between mb-6">
          ...
          {isMember ? <Link to={PATHS.KNOWLEDGE_CENTER} className="text-brand-pink hover:underline">
              View All
            </Link> : <div className="flex items-center gap-2 text-gray-500">
      ...
      <section className="mb-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            ...
            {isMember ? <Button asChild>
                <Link to={PATHS.KNOWLEDGE_CENTER}>
                  Explore Videos
                </Link>
              </Button> : <Button variant="outline" onClick={handleNonMemberClick}>
      ...
      <section className="mb-12">
        <div className="flex items-center justify-between mb-6">
          ...
          {isMember ? <Link to={PATHS.MEMBER_DIRECTORY} className="text-brand-pink hover:underline">
              View All
            </Link> : <div className="flex items-center gap-2 text-gray-500">
              <Lock className="h-4 w-4" />
              <span className="text-sm">Member access required</span>
