  ...
  return (
    <div className="w-[214px] min-h-screen bg-brand-darkBlue flex flex-col fixed left-0 top-0 text-white">
      ...
      <div className="p-6 space-y-2">
        <a href="https://wilbe.com/apply" target="_blank" rel="noreferrer" className="block w-full bg-green-500 text-white py-2 rounded-md text-center font-medium hover:bg-green-600 transition-colors">Start BSF</a>
        <a href="https://wilbe.com/bsf" target="_blank" rel="noreferrer" className="block w-full text-white text-center text-sm hover:underline">
          Learn about BSF
        </a>
