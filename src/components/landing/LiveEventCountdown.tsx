  ...
  return (
    <div className="grid grid-cols-4 gap-2 mb-4">
      <div className="text-center">
        <div className="bg-gray-100 border border-gray-300 text-gray-900 text-base sm:text-lg font-bold py-2 px-1 sm:px-2 rounded min-h-[44px] flex items-center justify-center">
          {timeLeft.days}
        </div>
