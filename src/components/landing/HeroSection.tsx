    ...
    <div className="lg:col-span-2">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <Link to="/quiz" target="_blank" rel="noopener noreferrer">
          <Button
            size="lg"
            className="bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 hover:from-purple-600 hover:via-pink-600 hover:to-orange-600 text-white font-bold uppercase tracking-wide px-8 border-0 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl animate-[pulse_5s_ease-in-out_infinite]"
          >
