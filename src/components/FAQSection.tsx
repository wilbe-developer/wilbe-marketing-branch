  ...
  return (
    <section className="container mb-24">
      <div className="flex flex-col md:flex-row gap-4 items-start mb-16">
        ...
        <h2 className="text-4xl md:text-5xl font-bold max-w-3xl">Frequently Asked Questions</h2>
      </div>
      ...
      <Accordion type="single" collapsible className="space-y-2">
        ...
        <AccordionItem value="item-15" className="border border-white/30 p-4">
          ...
          <AccordionContent className="mt-2 text-white/70 text-lg">
            ...
            <p className="mt-2">
              If you think BSF is too advanced for your current stage, please join <a href="https://wilbe.com/sandbox" target="_blank" rel="noopener noreferrer" className="text-white underline hover:text-[#7ED957]">Wilbe Sandbox</a> with free educational content and a community of like-minded scientists.
            </p>
          </AccordionContent>
        </AccordionItem>
